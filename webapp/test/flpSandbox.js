		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Meteorología",
									"targetURL": "#aipmeteorologia-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aipmeteorologia-display": {
								"semanticObject": "aipmeteorologia",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aip.meteorologia",
									"url": sap.ui.require.toUrl("aip/meteorologia")
								}
							}
						}
					}
